...
export function Footer() {
  return (
    <footer className="relative bg-white border-t border-border/40 pt-16 pb-8 overflow-hidden">
      {/* Glowing bar */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-3/4 flex flex-col items-center">
        <div className="w-full h-1.5 bg-gradient-to-r from-transparent via-hero-accent to-transparent rounded-full" />
        <div className="w-full h-16 bg-hero-accent/30 rounded-full blur-2xl" />
        <div className="w-3/4 h-24 bg-hero-accent/20 rounded-full blur-3xl -mt-8" />
      </div>
