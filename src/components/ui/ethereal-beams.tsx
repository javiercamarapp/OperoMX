...
const DirLight: FC<{ position: [number, number, number]; color: string }> = ({ position, color }) => {
  ...
  return <directionalLight ref={dir} color={color} position={position} intensity={20} castShadow />
}
  ...
  return (
    <CanvasWrapper>
      <group rotation-z={degToRad(rotation)}>
        <PlaneNoise ref={meshRef} count={beamNumber} material={beamMaterial} width={beamWidth} height={beamHeight} />
